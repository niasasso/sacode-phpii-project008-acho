            ...
            <div class="col-6 mx-auto">
                ...
                <div class="card shadow bg-dark text-warning rounded-5">
                    ...
                    <div class="card-header text-center p-5">
                        <h1 class="display-1 fw-bolder text-warning">Login</h1>
                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="login-proses.php" method="post">
                            ...
                            <button type="submit" class="btn btn-lg btn-warning w-100 fw-bolder py-3">Login</button>
                    ...
                    <div class="card-footer text-center py-5">
                        Belum punya akun? <a href="index.php" class="fw-bold text-decoration-none">Register</a>
                    </div>
                    <!-- .card-footer end -->
